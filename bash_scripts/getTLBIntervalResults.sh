...
#takes year, size, benchmark, and dir as parameters - sample every 100 ms
generate_results () {
...
dTLB-loads,dTLB-load-misses,dTLB-stores,dTLB-store-misses,iTLB-loads,iTLB-load-misses -I 100" | \
...
do
	...
	dir="./tlb_interval_results/${benchmark}_${year}"
	mkdir "${dir}"
